...
<head>
    ...
    <title>Masuk — Wisata Budaya Lombok</title>
    ...
    <div class="auth-container">
        ...
        <div class="auth-banner">
            ...
            <div class="auth-banner-content">
                <span class="auth-badge">
                    <i data-lucide="compass" style="width: 13px; height: 13px;"></i> Wisata Sasak
                </span>
                <h1 class="auth-banner-title">Selamat Datang Kembali</h1>
                <p class="auth-banner-desc">Masuk untuk menyimpan lokasi favorit dan mengelola wisata Anda.</p>
            </div>

            <div class="auth-features">
                <div class="feature-item">
                    <i data-lucide="check-circle" style="width: 16px; height: 16px; color: #d9a441;"></i>
                    <span>Simpan destinasi impian</span>
                </div>
                <div class="feature-item">
                    <i data-lucide="check-circle" style="width: 16px; height: 16px; color: #d9a441;"></i>
                    <span>Akses ulasan komunitas</span>
                </div>
            </div>
        </div>
        ...
        <div class="auth-form-section">
            <div class="form-header">
                <h2>Masuk Akun</h2>
                <p>Gunakan Google atau email terdaftar Anda</p>
            </div>
            ...
            @if ($errors->any())
                <div class="alert-error">
                    <i data-lucide="alert-circle" style="width: 16px; height: 16px; shrink: 0;"></i>
            ...
            <form method="POST" action="{{ route('login.store') }}">
                ...
                @error('cf-turnstile-response')
                    <p style="color: #e53e3e; font-size: 12px; text-align: center; margin-bottom: 12px;">{{ $message }}
                    </p>
                @enderror
