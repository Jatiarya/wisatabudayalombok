<x-layout title="Produk Khas Wisata Budaya Lombok">
            ...
            <div class="grid lg:grid-cols-12 gap-8 items-center">
                ...
                <div class="lg:col-span-7 text-center lg:text-left">
                    <span
                        ...
                        <x-lucide-flask-conical class="w-3.5 h-3.5 text-lombok-gold"></x-lucide-flask-conical> Produk
                        Khas & Oleh-Oleh
                    </span>
                    <h1 class="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-4 leading-tight">
                        Koleksi <span class="text-lombok-gold">Produk Khas Lombok</span>
                    </h1>
                    <p class="max-w-xl mx-auto lg:mx-0 text-lombok-cream/90 text-sm md:text-base leading-relaxed">
                        Minyak tradisional, jamu, dan oleh-oleh khas warisan budaya turun-temurun Suku Sasak yang
                        autentik.
                    </p>
                </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                <div
                                    ...
                                    <x-lucide-shopping-bag class="w-5 h-5 text-lombok-gold"></x-lucide-shopping-bag>
                                </div>
                                <div>
                                    <h3 class="font-bold text-white text-base">Warisan Lokal Asli</h3>
                                    <p class="text-xs text-lombok-cream/80">Koleksi kerajinan dan produk pilihan</p>
                                </div>
                            </div>
                            <div
                                class="pt-3 border-t border-white/10 flex justify-between text-xs text-lombok-cream/90">
                                <span>Total Kategori Produk</span>
        ...
        <form method="GET" class="glass-panel flex flex-wrap gap-3 p-4 md:p-5 shadow-xl shadow-black/5">
            <div class="relative flex-1 min-w-[200px]">
                ...
                <input type="text" name="q" value="{{ request('q') }}"
                    placeholder="Cari produk atau oleh-oleh..."
    ...
    <section class="max-w-6xl mx-auto px-4 py-12 md:py-16">
        @if ($products->isEmpty())
            <div class="text-center py-16 bg-white/40 backdrop-blur-md rounded-3xl border border-white/50">
                <div
                    ...
                    <x-lucide-package-open class="w-8 h-8"></x-lucide-package-open>
                </div>
                <h3 class="font-bold text-lg text-lombok-earth mb-1">Produk Tidak Ditemukan</h3>
                <p class="text-gray-500 text-sm max-w-md mx-auto">Tidak ada produk atau oleh-oleh yang cocok dengan
                    kriteria pencarian atau filter yang Anda pilih.</p>
        ...
        @else
            ...
            <!-- Pagination dengan Query String yang Terjaga -->
