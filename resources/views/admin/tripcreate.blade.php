<x-admin-layout title="Tambah Paket Trip">
    <div x-data x-init="$nextTick(() => lucide.createIcons())">
        ...
        <div class="glass-panel p-6 max-w-2xl">
            <h2 class="font-bold text-lombok-earth mb-1">Tambah Paket Trip</h2>
            <p class="text-sm text-lombok-earth/60 mb-5">Buat paket perjalanan baru beserta itinerary-nya.</p>
            ...
            <form method="POST" action="{{ route('admin.trips.store') }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        placeholder="contoh: Explore Lombok 3D2N" class="input-glass w-full mt-1">
                </div>

                <div>
                    <label class="text-sm font-medium text-lombok-earth">Deskripsi</label>
                    <textarea name="description" rows="4" required placeholder="Ceritakan tentang paket trip ini..."
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="duration_days" value="{{ old('duration_days', 1) }}" required
                            min="1" class="input-glass w-full mt-1">
                    </div>
                    <div>
                        ...
                        <input type="number" name="duration_nights" value="{{ old('duration_nights', 0) }}"
                            min="0" class="input-glass w-full mt-1">
                    </div>
                </div>
