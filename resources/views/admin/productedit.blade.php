<x-admin-layout title="Edit Produk">
    <div x-data x-init="$nextTick(() => lucide.createIcons())">
        ...
        <div class="glass-panel p-6 max-w-2xl">
            <h2 class="font-bold text-lombok-earth mb-1">Edit Produk</h2>
            ...
            <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" required class="input-glass w-full mt-1">{{ old('description', $product->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price', $product->price) }}" min="0"
                        step="1000" class="input-glass w-full mt-1">
                </div>

                {{-- Thumbnail: default tampilkan gambar lama --}}
                <div x-data="{ fileName: '', preview: @js($product->thumbnail ? asset('storage/' . $product->thumbnail) : null) }">
                    ...
                    <label for="thumbnail"
                        ...
                        <span class="text-xs text-lombok-earth/60 px-4 text-center"
                            x-text="fileName || 'Klik untuk ganti gambar produk (JPG/PNG, maks 2MB)'"></span>
                    </label>
